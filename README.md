About pegasus-wms.api-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pegasus-wms.api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pegasus-wms.api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pegasus-wms.api
# for installing globally
pixi global install pegasus-wms.api
```
...
It is possible to list all of the versions of `pegasus-wms.api` available on your platform:
...
```
pixi search pegasus-wms.api --channel conda-forge
```
